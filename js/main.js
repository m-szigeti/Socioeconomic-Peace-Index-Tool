...
function getPillarDisplayName(pillarId) {
    const pillarNames = {
        ...
        'pop_frac_3plus': 'Fraction of population in IPC Phase 3 or higher',
        'years_of_schooling': 'Years of Schooling Deprivation',
        'primary_school_net_attendance_gp_index': 'Primary school net attendance gender parity index',
        'net_attendance_total': 'Secondary Attendance (Total)',
        'secondary_school_net_attendance_gp_index': 'Secondary school net attendance gender parity index',
        'school_access_pop': 'Population with school access',
        'poverty': 'Poverty Reduction Index',
        'cooking_fuel': 'Cooking Fuel Deprivation',
        'sanitation': 'Sanitation Deprivation',
        'drinking_water': 'Drinking Water Deprivation',
        'electricity': 'Electricity Deprivation',
        'housing': 'Housing Deprivation',
        'assets': 'Assets Deprivation',
        'poverty_headcount_pct': 'Poverty headcount (population below poverty line)',
        'gcp_pc': 'Gross County Product Per Capita',
        'youth_bulge': 'Share of male population aged 15 to 29',
        'health': 'Health Access Index',
        'health_fac_per_10k_pop': 'Health facilities per 10,000 population',
        'hp_hc_per_10k_pop': 'Health posts plus health centres per 10,000 population',
        'hospitals_per_100k_pop': 'Hospitals per 100,000 population',
        'healthcare_access_pop': 'Population with healthcare access',
        'nutrition': 'Nutrition Deprivation',
        'child_mortality': 'Child Mortality Deprivation',
        ...
        'percent_no_formal_education': 'Percent no formal education',
        'percent_highest_level_secondary_education': 'Percent highest level secondary education',
        'percent_highest_level_primary_education': 'Percent highest level primary education',
        'percent_highest_level_university_education': 'Percent highest level university education',
        'school_attendance': 'School Attendance Deprivation',
        'percent_enrollment_male': 'Percent of male students',
        'percent_enrollment_female': 'Percent of female students',
        'gender_parity_index': 'Gender parity index',
        'dropout_pct': 'Student dropout rate',
        'pqtr_pct': 'Pupil-qualified teacher ratio',
        'on_payroll_pct': 'Share of teachers on payroll',
        'mch_ctr_per_10k_pop': 'MCH centres per 10,000 population',
        'access_to_healthcare': 'Access to Healthcare Deprivation',
        'food_security_deprivation': 'Food Security Deprivation',
        'water': 'Drinking Water Deprivation',
        'overcrowding': 'Overcrowding Deprivation',
        'unemployment': 'Unemployment Deprivation',
        'shocks': 'Shocks Deprivation',
        'total_expenditure_usd': 'Total expenditure usd',
        'food_percentage_share_pct': 'Food percentage share percent',
        'extreme_poverty_headcount_pct': 'Extreme poverty headcount',
        'youth_unemployment': 'Share of youth unemployed',
        'annual_cmb_mean': 'Average annual CMB cost',
        'non_agri_wage': 'Average non-agricultural wage',
